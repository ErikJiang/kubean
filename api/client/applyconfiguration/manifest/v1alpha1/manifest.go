...
func Manifest(name string) *ManifestApplyConfiguration {
	...
	b.WithName(name)
	b.WithKind("Manifest")
	b.WithAPIVersion("manifest.kubean.io/v1alpha1")
	return b
}
...
func (b *ManifestApplyConfiguration) WithSpec(value *SpecApplyConfiguration) *ManifestApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *ManifestApplyConfiguration) WithStatus(value *StatusApplyConfiguration) *ManifestApplyConfiguration {
	b.Status = value
	return b
}
