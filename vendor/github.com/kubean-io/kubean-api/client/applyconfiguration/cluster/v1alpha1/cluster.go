...
func Cluster(name string) *ClusterApplyConfiguration {
	...
	b.WithName(name)
	b.WithKind("Cluster")
	b.WithAPIVersion("cluster.kubean.io/v1alpha1")
	return b
}
...
func (b *ClusterApplyConfiguration) WithSpec(value *SpecApplyConfiguration) *ClusterApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *ClusterApplyConfiguration) WithStatus(value *StatusApplyConfiguration) *ClusterApplyConfiguration {
	b.Status = value
	return b
}
